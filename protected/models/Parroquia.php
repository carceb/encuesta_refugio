...
class Parroquia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('nombre_parroquia', 'length', 'max'=>128),
	...
	public function relations()
	{
		...
		return array(
			'damnificados' => array(self::HAS_MANY, 'Damnificado', 'id_parroquia'),
			'refugios' => array(self::HAS_MANY, 'Refugio', 'id_parroquia'),
			'idMunicipio0' => array(self::BELONGS_TO, 'Municipio', 'id_municipio'),
		);
	}
